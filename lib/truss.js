...
/***/ function(module, exports, __webpack_require__) {
	...
	var TrussLayout = function () {
	   ...
	   */
						...
						elem.addEventListener('mouseup', function () {
							...
							if (sliderProps.newY) {
								...
								if (slider[len - 1] && slider[len - 1].isVertical === false && !slider[len - 1].dimensions) {
									...
									_dim.y1 = _props[2].y === Infinity ? _sliderProps.positive = self.gridConf.hMax : _sliderProps.positive = _props[2].y;
									_dim.y2 = _props[3].y === Infinity ? _sliderProps.positive = self.gridConf.hMax : _sliderProps.positive = _props[3].y;
								}
								// next slider
								if (slider[len + 1] && slider[len + 1].isVertical === false && !slider[len + 1].dimensions) {
									...
									_dim2.y1 = _props2[2].y === Infinity ? _sliderProps2.positive = self.gridConf.hMax : _sliderProps2.positive = _props2[2].y;
									_dim2.y2 = _props2[3].y === Infinity ? _sliderProps2.positive = self.gridConf.hMax : _sliderProps2.positive = _props2[3].y;
								}
						...
						elem.addEventListener('mouseup', function () {
							...
							if (sliderProps.newX) {
								...
								if (slider[len - 1] && slider[len - 1].isVertical === true && !slider[len - 1].dimensions) {
									...
									_dim3.x1 = _props3[2].x === Infinity ? _sliderProps3.positive = self.gridConf.wMax : _sliderProps3.positive = _props3[2].x;
									_dim3.x2 = _props3[3].x === Infinity ? _sliderProps3.positive = self.gridConf.wMax : _sliderProps3.positive = _props3[3].x;
								}
								// next slider
								if (slider[len + 1] && slider[len + 1].isVertical === true && !slider[len + 1].dimensions) {
									...
									_dim4.x1 = _props4[2].x === Infinity ? _sliderProps4.positive = self.gridConf.wMax : _sliderProps4.positive = _props4[2].x;
									_dim4.x2 = _props4[3].x === Infinity ? _sliderProps4.positive = self.gridConf.wMax : _sliderProps4.positive = _props4[3].x;
								}
			...
			value: function _excuteSliderChange(isVertical, change, props) {
				var s1 = props[0],
				    s2 = props[1];
...
/***/ function(module, exports) {
	...
	*/
	...
	exports.roundUpNearest = roundUpNearest;
