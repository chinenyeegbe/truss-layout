...
/***/ function(module, exports, __webpack_require__) {
	...
	var Grid = function () {
	   ...
	   */
			...
			value: function resizeInnerContainers(isvertical, change, operation) {
				...
				for (var _key in sliders) {
					if (sliders.hasOwnProperty(_key)) {
						this.changeSliderDimension(sliders[_key], isvertical, amount, _key);
					}
				}
			...
			value: function changeSliderDimension(sliderObj, isVertical, amount, key) {
